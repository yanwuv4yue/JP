...
CREATE TABLE IF NOT EXISTS `t_tgks_mar_marzaccount` (
  ...
  `sellCardIds` varchar(5000) default NULL COMMENT '出售卡片ID',
  `fameCardIds` varchar(5000) default NULL COMMENT '自动合成名声卡片ID',
  `itemInfo` varchar(1000) default NULL COMMENT '物品信息',
